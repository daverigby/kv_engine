...
In addition to the above defined status codes, the following ranges are reserved for specific purposes:

| Range | Description                           |
|-------|---------------------------------------|
| 0xff00 - 0xffff | Reserved for end-user applications (e.g. proxies). Couchbase itself will not return them. |
